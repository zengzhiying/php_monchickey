 ...
 * 阴历范围严格限制在闭区间:[1902年正月初一 ~ 2037年腊月十五] 超出范围会出问题
 */
class LunarCalendar { 
    const MIN_YEAR = 1891; 
    const MAX_YEAR = 2100; 
    ...
    * @param date 公历-日  
    */  
    public function solarToLunar($year,$month,$date){
    ...
    private function convertSolarMonthToLunar($year,$month){ 
        $yearData=$this->lunarInfo[$year-self::MIN_YEAR]; 
        if($year==self::MIN_YEAR&&$month<=2&&$date<=9){  
            return array(1891,'正月','初一','辛卯',1,1,'兔'); 
        } 
    ...
    * @param date 阴历-日  
    */  
    public function lunarToSolar($year,$month,$date){  
        $yearData=$this->lunarInfo[$year-self::MIN_YEAR]; 
    ...
    * @param year  
    */  
    private function getLunarYearName($year){  
    ...
    * @param year 阴历年  
    */  
    private function getYearZodiac($year){  
    ...
    * @param month 阳历-月  
    */  
    private function getSolarMonthDays($year,$month){  
    ...
    * @param year  
    */  
    private function getLunarMonths($year){  
        $yearData=$this->lunarInfo[$year-self::MIN_YEAR]; 
    ...
    */  
    ...
    private function getLunarYearMonths($year){//debugger; 
        $monthData=$this->getLunarMonths($year); 
        $res=array(); 
        $temp=0; 
        $yearData=$this->lunarInfo[$year-self::MIN_YEAR]; 
    ...
    * @param date  
    */  
    private function getDaysBetweenLunar($year,$month,$date){  
    ...
    */  
    private function getDaysBetweenSolar($year,$cmonth,$cdate,$dmonth,$ddate){  
    ...
    * @param between 天数  
    */  
    private function getLunarByBetween($year,$between){//debugger; 
        $lunarArray=array(); 
        $yearMonth=array(); 
        $t=0; 
        $e=0; 
